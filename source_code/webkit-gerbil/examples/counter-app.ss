;;; counter-app.ss — Interactive bridge demo for webkit-gerbil
;;;
;;; A counter app that demonstrates the JS ↔ Scheme bridge:
;;;   - "increment" / "decrement" commands modify Scheme-side state
...
(register-handler "get-system-info"
  (lambda (payload)
    (json-response "lisp" "Gerbil Scheme (Gambit)"
...
(def (main . args)
  (let ((a (create-app title: "Counter - webkit-gerbil" width: 500 height: 520)))
    (load-html
     "<!DOCTYPE html>
<html>
<head>
  ...
  <script>
    ...
    setTimeout(async () => {
      try {
        ...
        info.textContent = 'JS ↔ Scheme bridge active';
      }
    }, 500);
  </script>
</body>
